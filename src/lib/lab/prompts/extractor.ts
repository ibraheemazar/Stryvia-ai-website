...
- value: a concise, faithful summary in the visitor's own terms (their language may be Arabic, English or mixed; write the value in the language they used). Never invent numbers.
