...
import { buildCopilotContext, serializeContext } from "@/lib/insights/context";
import { COPILOT_SYSTEM } from "@/lib/insights/prompts";
...
// Streamed admin Copilot: answers anything across analytics + leads +
// conversations, grounded in the assembled admin context.
export async function POST(req: NextRequest) {
  ...
  const ctx = await buildCopilotContext(range);
